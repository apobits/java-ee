    ...
    extends Service
{
    ...
    public PersonIF1 getPersonPort() {
        return super.getPort(new QName("http://soap.services.learning.web/", "PersonPort"), PersonIF1.class);
    }
     ...
     */
    @WebEndpoint(name = "PersonPort")
    public PersonIF1 getPersonPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.services.learning.web/", "PersonPort"), PersonIF1.class, features);
    }
